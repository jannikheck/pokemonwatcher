...
MAX_PAGES = 8                        # max. Shopify-Seiten je Shop (250 Produkte/Seite -> 2000)
# Pause zwischen zwei VERSCHIEDENEN Shops darf kurz sein: das sind fremde Server,
# Hoeflichkeit zaehlt pro Domain. Die Pause zwischen Katalogseiten desselben
# Shops ist die wichtige - die bleibt hoeher.
PER_SHOP_DELAY = (0.5, 1.5)          # zufaellige Pause (Sek.) zwischen Shops
PER_PAGE_DELAY = (1, 2)              # zufaellige Pause (Sek.) zwischen Seiten EINES Shops
...
# 4) Sprachen, die du NICHT willst. Du willst nur DEUTSCHE und ENGLISCHE Ware,
#    also fliegt alles raus, was sich explizit als japanisch/chinesisch/koreanisch
#    ausweist - und zwar in allen Shop-Sprachen, weil ein tschechischer Shop
#    "japonské" schreibt und ein italienischer "giapponese".
#    WICHTIG: Produkte OHNE Sprachangabe (z.B. "Pokémon 151 Elite Trainer Box")
#    kommen bewusst durch - sonst wuerdest du den Grossteil der EN/DE-Ware
#    verlieren, weil die Sprache dort meist gar nicht im Titel steht.
EXCLUDE_LANGUAGES = [
    # chinesisch
    "chinesisch", "s-chinesisch", "chinese", "simplified chinese", "traditional chinese",
    "chinees", "cinese", "chino", "chinski", "chinski", "kinesisk", "chinois",
    # japanisch
    "japanisch", "japanese", "japans", "japonske", "japonsky", "japonski",
    "giapponese", "japones", "japansk", "japonais", "jap", "jp", "ocg",
    # koreanisch
    "koreanisch", "korean", "koreansk", "coreano",
]
...
SHOPS = [
    ...
    # -- durch deine eigenen Laeufe bestaetigt (Telegram-Meldungen / watcher_state) --
    {"shop": "Pokitrio",         "country": "DE", "base": "https://www.pokitrio.de",      "verified": True},
    {"shop": "God of Cards",     "country": "DE", "base": "https://godofcards.com",       "verified": True},
    {"shop": "FantasiaCards",    "country": "DE", "base": "https://fantasiacards.de",     "verified": True},
    {"shop": "CardBuddies",      "country": "DE", "base": "https://cardbuddies.de",       "verified": True},
    # -- Kandidaten (Plattform wird beim Lauf geprueft) --
    ...
    {"shop": "TcG Love DE",      "country": "DE", "base": "https://tcg-love.de",          "verified": None},
    ...
    # ################## EUROPA - Shopify bestaetigt (Recherche 08/2026) ##################
    # Alle vier verkaufen englischsprachige Ware und versenden i.d.R. EU-weit.
    {"shop": "Total Cards",      "country": "GB", "base": "https://totalcards.net",        "verified": True},
    {"shop": "TCG Stadium",      "country": "GB", "base": "https://tcg-stadium.com",       "verified": True},
    {"shop": "Otakura",          "country": "IT", "base": "https://otakura.com",           "verified": True},
    {"shop": "TCG Collection",   "country": "ES", "base": "https://tcg-collection.com",    "verified": True},
    {"shop": "TCGStore.se",      "country": "SE", "base": "https://tcgstore.se",           "verified": True},
    {"shop": "Templars Arena",   "country": "EU", "base": "https://templarsarena.com",     "verified": True},
    {"shop": "Hobby Addicts",    "country": "EU", "base": "https://www.hobby-addicts.com", "verified": True},

    # ################## GRIECHENLAND ##################
    {"shop": "Gamescape.gr",       "country": "GR", "base": "https://gamescape.gr",                "verified": None},
    {"shop": "CollectorCenter.gr", "country": "GR", "base": "https://www.collectorcenter.gr",      "verified": None},
    {"shop": "Black Flame",        "country": "GR", "base": "https://www.blackflamecollectibles.com","verified": None},
    {"shop": "ExtremePokeCorner",  "country": "GR", "base": "https://extremepokecorner.com",       "verified": None},
    {"shop": "Nerdom.gr",          "country": "GR", "base": "https://www.nerdom.gr",               "verified": None},
    {"shop": "eFantasy.gr",        "country": "GR", "base": "https://www.efantasy.gr",             "verified": None},

    # ################## TSCHECHIEN ##################
    # CZ-Shops verkaufen fast nur englische Ware (tschechische Pokémon-Produkte
    # werden gar nicht produziert) -> fuer dich besonders interessant.
    {"shop": "PokecTCG",      "country": "CZ", "base": "https://pokectcg.cz",        "verified": None},
    {"shop": "Gengar.cz",     "country": "CZ", "base": "https://www.gengar.cz",      "verified": None},
    {"shop": "Pokemall.cz",   "country": "CZ", "base": "https://www.pokemall.cz",    "verified": None},
    {"shop": "TCGkarty.cz",   "country": "CZ", "base": "https://www.tcgkarty.cz",    "verified": None},
    {"shop": "BubuObchod.cz", "country": "CZ", "base": "https://www.bubuobchod.cz",  "verified": None},

    # ################## NIEDERLANDE / BELGIEN ##################
    {"shop": "PKMWinkel",        "country": "NL", "base": "https://www.pkmwinkel.nl",       "verified": None},
    {"shop": "TCG Company",      "country": "NL", "base": "https://tcgcompany.nl",          "verified": None},
    {"shop": "TCGfanz",          "country": "NL", "base": "https://tcgfanz.nl",             "verified": None},
    {"shop": "CollectableWorld", "country": "NL", "base": "https://www.collectableworld.nl","verified": None},
    {"shop": "Pokenatics",       "country": "NL", "base": "https://www.pokenatics.nl",      "verified": None},
    {"shop": "BESCARDS",         "country": "NL", "base": "https://www.bescards.com",       "verified": None},
    {"shop": "BoosterShop.be",   "country": "BE", "base": "https://www.boostershop.be",     "verified": None},
    {"shop": "HiroShop.be",      "country": "BE", "base": "https://www.hiroshop.be",        "verified": None},

    # ################## POLEN ##################
    {"shop": "BoosterPoint",      "country": "PL", "base": "https://boosterpoint.pl",        "verified": None},
    {"shop": "BoosterBreak",      "country": "PL", "base": "https://boosterbreak.pl",        "verified": None},
    {"shop": "TCG Love PL",       "country": "PL", "base": "https://www.tcglove.pl",         "verified": None},
    {"shop": "LofiCards",         "country": "PL", "base": "https://loficards.pl",           "verified": None},
    {"shop": "PokeGemCollector",  "country": "PL", "base": "https://www.pokegemcollector.pl","verified": None},
    {"shop": "MyCards.pl",        "country": "PL", "base": "https://mycards.pl",             "verified": None},
    {"shop": "PokeBooster.pl",    "country": "PL", "base": "https://pokebooster.pl",         "verified": None},
    {"shop": "LetsGoTry",         "country": "PL", "base": "https://letsgotry.pl",           "verified": None},

    # ################## WEITERE ##################
    {"shop": "The TCG Shop UK",   "country": "GB", "base": "https://www.thetcgshop.co.uk",   "verified": None},
    {"shop": "PlayingCardShop",   "country": "EU", "base": "https://www.playingcardshop.eu", "verified": None},
]
...
def _norm(text):
    """Kleinbuchstaben + Akzente entfernen, damit 'Pokémon'/'pokemon' und
    'japonské'/'japonske' gleich behandelt werden (wichtig fuer CZ/PL/IT-Shops)."""
...
# Sprachbegriffe ebenfalls mit Wortgrenzen pruefen, damit kurze Kuerzel wie "jp"
# nicht mitten in anderen Woertern zuenden.
_LANG_RE = (
    re.compile(r"\b(" + "|".join(re.escape(_norm(t)) for t in EXCLUDE_LANGUAGES) + r")\b")
    if EXCLUDE_LANGUAGES else None
)
...
def is_excluded_language(product):
    if _LANG_RE is None:
        return False
    return bool(_LANG_RE.search(_full_blob(product)))
